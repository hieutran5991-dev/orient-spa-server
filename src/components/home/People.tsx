...
const testimonials = [
  {
    ...
    review:
      '我們沒有預約，第一次帶媽媽來按摩，儘管如此，服務人員很客氣，也給我們說服務項目並提供預約時間。後來我們來了兩次，並因為生意很好，多付一次錢，他們有發現並告知我們扣回，覺得優良企業。服務很棒，推薦大家'
  },
  {
    id: 2,
    name: 'Loisy',
  ...
  },
  {
    ...
    review:
      'Wonderful spa! We got the healing touch package and they were happy to fit us in last minute and adapt the package to our needs. Everyone was professional, friendly and nice. Very relaxing atmosphere and we left feeling great, highly recommend.'
  },
  {
    id: 4,
    name: 'Aedan Gibson',
  ...
  },
  {
    ...
    review:
      '완전 강력 추천합니다. 한국말 너무 잘하시는 직원분이 계셔서 너무 편하게 마사지를 받았어요! 마사지사들도 너무 시원하게 잘 해주시고 시설도 깨끗해요 ㅎㅎㅎ'
  },
  {
    id: 6,
    name: 'Jessi',
  ...
  },
  {
    ...
    review:
      '90분 딥티슈마사지와 페디큐어를 받았어요. 미리 카카오톡으로 예약하고 올 수 있어서 넘 좋았구요. 공항에서 여기로 바로 왔더니 짐도 맡겨주셔서 편히 여행하고 돌아와 마사지 받았습니다. 따뜻하고 편안한 분위기 속에 마사지 받을 수 있었어요. 마사지 평소에 자주 받는 엄마도 만족해하셨어요. 사파 관광 후 다시 하노이 와서 여기서 다시 마사지 받을거예요.'
  }
]
    ...
    <div className='s sH s5'>
      <div className='container'>
        <div className='s_h'>
          ...
          <p className='s_p'>
            We hope you enjoy reading our guests&apos; reviews as much as ours. To all of us at Orient Spa, this means
              ...
              {testimonials.map((testimonial) => (
                <SwiperSlide key={testimonial.id}>
                  <div className='s5_i'>
                    <div className='s5_iw'>
                      <div className='s5_a'>
                        <Image src={testimonial.image} alt={testimonial.name} width={380} height={300} />
                      </div>
