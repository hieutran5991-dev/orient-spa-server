...
const FeaturedProducts = ({
  ...
  const handleBookNow = (service: Product) => {
    ...
    (document.querySelector(".a1") as HTMLElement).style.zIndex = "-1";
    (document.querySelector(".s5") as HTMLElement).style.zIndex = "-1";
    (document.querySelector(".s6") as HTMLElement).style.zIndex = "-1";
    (document.querySelector(".s7") as HTMLElement).style.zIndex = "-1";
  ...
  const closeModal = () => {
    ...
    (document.querySelector(".a1") as HTMLElement).style.zIndex = "";
    (document.querySelector(".s5") as HTMLElement).style.zIndex = "";
    (document.querySelector(".s6") as HTMLElement).style.zIndex = "";
    (document.querySelector(".s7") as HTMLElement).style.zIndex = "";
