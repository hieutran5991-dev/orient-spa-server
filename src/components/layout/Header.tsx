        ...
        <div className='h_w fl'>
          ...
          <div className='h_c w2 h1'>
            ...
            <ul className='h_n n1 fl'>
              <li>
                <a href={`/${locale}`}>{tCommon('navigation.home')}</a>
              </li>
              <li>
                <Link href={`/${locale}/services-prices`}>{tCommon('navigation.services')}</Link>
              </li>
              <li>
          ...
          <div className='h_c w2 h2 hidden-sm hidden-xs'>
            <ul className='h_n n2 fl'>
              <li className='h_d lhs'>
                <span>
                  {tCommon('navigation.about')} <i className='fa fa-angle-down'></i>
                </span>
                <ul className='h_s w1'>
                  <li>
                    <Link href='/page/about-us.html'>About Orient Spa</Link>
                  </li>
                  <li>
                    <ul>
                      <li>
                        <Link href='/spa/orient-spa-old-quarter.html'>Orient at 26 Au Trieu</Link>
                      </li>
                      <li>
                        <Link href='/spa/orient-spa-nails.html'>Orient at 18 Bao Khanh</Link>
                      </li>
                      <li>
                        <Link href='/spa/la-flora-by-orient.html'>La Flora at 22 Au Trieu</Link>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <Link href='/gallery.html'>Our happy guests</Link>
                  </li>
                  <li>
              ...
              <li className='lhs'>
                <Link href={`/${locale}/contact`}>{tCommon('navigation.contact')}</Link>
              </li>
              <li className='lhs'>
                <Link href={`/${locale}/reservation`}>{tCommon('navigation.reservation')}</Link>
              </li>
              <li className='lgs'>
                <span className='lgs_h'>
                ...
                <ul className='h_s w2'>
                  <li>
                    <button
                      ...
                      className={`bg-transparent border-none text-inherit font-inherit cursor-pointer px-3 py-2 w-full text-left transition-colors duration-200 ease-in-out hover:bg-black/10 ${
                        locale === 'en' ? 'bg-black/15 font-bold' : ''
                      }`}
                    >
                  ...
                  <li>
                    <button
                      ...
                      className={`bg-transparent border-none text-inherit font-inherit cursor-pointer px-3 py-2 w-full text-left transition-colors duration-200 ease-in-out hover:bg-black/10 ${
                        locale === 'vi' ? 'bg-black/15 font-bold' : ''
                      }`}
                    >
                  ...
                  <li>
                    <button
                      ...
                      className={`bg-transparent border-none text-inherit font-inherit cursor-pointer px-3 py-2 w-full text-left transition-colors duration-200 ease-in-out hover:bg-black/10 ${
                        locale === 'ja' ? 'bg-black/15 font-bold' : ''
                      }`}
                    >
