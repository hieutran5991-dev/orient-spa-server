      ...
      <div className='s k2'>
        <div className='container'>
          <div className='k2_w fl'>
                  ...
                  <div className='k2_dc active'>
                    ...
                    <div className='k2_dm'>
                      <ul className='k2_dn'>
                        ...
                        <li>
                          <strong>{t('location')}</strong> {bookingData.agency_name}
                        </li>
                        <li>
                          <strong>{t('numberOfGuests')}</strong> {bookingData.people}
                        </li>
                      </ul>
            ...
            {/* Booking Form */}
            <form className='k2_m' id='fromBook' autoComplete='off' onSubmit={handleSubmit}>
              <div className='k2_mw'>
                {guestForms.map((_, guestIndex) => {
                  const hasSelected = (bookingData?.booking_details?.[guestIndex]?.length || 0) > 0
                  return (
                    <div key={guestIndex} className='k2_i'>
                      ...
                      <div className='k2_b'>
                        <div className={`form-group ${hasSelected ? 'done' : 'has-feedback'}`}>
                          ...
                          <input
                            ...
                            value={bookingData?.booking_details?.[guestIndex]?.map((e) => e.name).join(', ')}
                            readOnly
                          />
                                ...
                                <div key={service.id} className='s8_i'>
                                  ...
                                  <div className='s8_v'>
                                    <input
                                      ...
                                      checked={bookingData?.booking_details?.[guestIndex]?.some(
                                        (e) => e.id === service.id
                                      )}
                                    />
              ...
              <div className='k2_f fl fl-2'>
                <button type='submit' className='btn btn-1 btn-block k2_u' disabled={isSubmitting}>
