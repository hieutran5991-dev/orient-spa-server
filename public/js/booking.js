...
$(document).ready(function () {
  ...
  for (var key in countriesByLetter) {
    ...
    countriesByLetter[key].forEach(function (country) {
      html +=
        "<dd>" + country.name + " <span>(" + country.dial + ")</span></dd>";
    });
    html += "</dl>";
  }
...
jQuery(document).ready(function ($) {
  var ww = $(window).width();
  $(".js-phone, .b1_ps, .js-guest, .k2_s, #country_search, #book_phone").on(
    "touchstart click",
    function (e) {
      e.stopPropagation();
    }
  ...
  const getGuests = () => [
    ...new Set(
      $('input[name^="guest_"][name$="_services"]')
        .map(function () {
  ...
  function syncFromGuest1() {
    ...
    $('[name="guest_1_services"]').each(function () {
      ...
      others.forEach((id) => {
        $(`[name="guest_${id}_services"][value="${val}"]`)
  ...
  $("#all").on("change", function () {
    if (this.checked) syncFromGuest1();
  });
  ...
  $('input[type="checkbox"][name^="guest_"][name$="_services"]').on(
    "change",
    function () {
  ...
  $(".js-v1, .js-v2, .js-v3, .js-v4, .s1_s").on(
    "touchstart click",
    function (e) {
      e.stopPropagation();
    }
